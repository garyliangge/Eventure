...
public class BlueListApplication extends Application {
    ...
    public static final String TODO_ITEM_LON_KEY = "lon";
     ...
     * @return The DocumentRevision of the created TodoItem
     */
    public DocumentRevision editTodoItem(BasicDocumentRevision documentRevision, final String newName, final String newPhoto) {
        ...
        if (newPhoto != null) {
            body.put(TODO_ITEM_ICON_KEY, newPhoto);
        }
    ...
    private void configureDatastore() {
        ...
        indexFields.add(TODO_ITEM_LON_KEY);
        indexFields.add(TODO_ITEM_LAT_KEY);
        indexFields.add(TODO_ITEM_ICON_KEY);
        mIndexManager.ensureIndexed(indexFields, TODO_ITEM_INDEX_NAME);
    }

    public void deleteDatastore() {
        try {
            mDatastoreManager.deleteDatastore(mRemoteDatabaseName);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
